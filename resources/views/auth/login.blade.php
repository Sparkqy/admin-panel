                    ...
                    <div class="my-4">
                        <div class="form-group has-feedback">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                   class="form-control  @include('partials.messages.validation-error-input-class', ['fieldName' => 'password'])"
                        ...
                        <div class="form-group has-feedback">
                            ...
                            @include('partials.messages.validation-errors', ['fieldName' => 'password'])
                        </div>
                    </div>
